...
export default function Recipes() {
      ...
      recipes.forEach((recipe) => {
        filters.forEach((filter) => {
          if (
            ...
            recipe.tags.filter((tag) => tag !== filter).length === 0
          ) {
            set.add(recipe);
          }
        });
  ...
  function onAllergyChange(e, name) {
    ...
    newFilters.push(name);
    e.target.checked
      ? setAllergies(newFilters)
      : setAllergies(allergies.filter((item) => item !== name));
  }
          ...
          <div className="flex flex-col gap-1">
            <div className="flex gap-2">
              <input
                type="checkbox"
                name="coffeemaker"
                onChange={(e) => onToolChange(e, "Coffee")}
              />
            ...
            <div className="flex gap-2">
              <input
                type="checkbox"
                name="ricecooker"
                onChange={(e) => onToolChange(e, "Rice Cooker")}
              />
            ...
            <div className="flex gap-2">
              <input
                type="checkbox"
                name="cooler"
                onChange={(e) => onToolChange(e, "Cooler/Refrigerator")}
              />
            ...
            <div className="flex gap-2">
              <input
                type="checkbox"
                name="foodprocessor"
                onChange={(e) => onToolChange(e, "Food Processor")}
              />
            ...
            <div className="flex gap-2">
              <input
                type="checkbox"
                name="crockpot"
                onChange={(e) => onToolChange(e, "Crockpot")}
              />
            ...
            <div className="flex gap-2">
              <input
                type="checkbox"
                name="blender"
                onChange={(e) => onToolChange(e, "Blender")}
              />
            ...
            <div className="flex gap-2">
              <input
                type="checkbox"
                name="stove"
                onChange={(e) => onToolChange(e, "Stove/Campfire")}
              />
            ...
            <div className="flex gap-2">
              <input
                type="checkbox"
                name="microwave"
                onChange={(e) => onToolChange(e, "Microwave")}
              />
            ...
            <div className="flex gap-2">
              <input
                type="checkbox"
                name="oven"
                onChange={(e) => onToolChange(e, "Oven")}
              />
            ...
            <div className="flex gap-2">
              <input
                type="checkbox"
                name="nosupplies"
                onChange={(e) => onToolChange(e, "No Supplies")}
              />
          ...
          <div className="flex flex-col gap-1">
            <div className="flex gap-2">
              <input
                type="checkbox"
                name="milk"
                onChange={(e) => onAllergyChange(e, "Milk")}
              />
            ...
            <div className="flex gap-2">
              <input
                type="checkbox"
                name="eggs"
                onChange={(e) => onAllergyChange(e, "Eggs")}
              />
            ...
            <div className="flex gap-2">
              <input
                type="checkbox"
                name="nuts"
                onChange={(e) => onAllergyChange(e, "Nuts")}
              />
            ...
            <div className="flex gap-2">
              <input
                type="checkbox"
                name="fish"
                onChange={(e) => onAllergyChange(e, "Fish")}
              />
            ...
            <div className="flex gap-2">
              <input
                type="checkbox"
                name="crustaceans"
                onChange={(e) => onAllergyChange(e, "Crustaceans")}
              />
            ...
            <div className="flex gap-2">
              <input
                type="checkbox"
                name="shellfish"
                onChange={(e) => onAllergyChange(e, "Shellfish")}
              />
            ...
            <div className="flex gap-2">
              <input
                type="checkbox"
                name="wheat"
                onChange={(e) => onAllergyChange(e, "Wheat")}
              />
            ...
            <div className="flex gap-2">
              <input
                type="checkbox"
                name="soy"
                onChange={(e) => onAllergyChange(e, "Soy")}
              />
            ...
            <div className="flex gap-2">
              <input
                type="checkbox"
                name="sesame"
                onChange={(e) => onAllergyChange(e, "Sesame")}
              />
            ...
            <div className="flex gap-2">
              <input
                type="checkbox"
                name="gluten"
                onChange={(e) => onAllergyChange(e, "Gluten")}
              />
